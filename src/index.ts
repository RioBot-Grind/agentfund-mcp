...
class AgentFundMCPServer {
      ...
      try {
        switch (name) {
          ...
          case "estimate_create_project":
            return await this.estimateCreateProject(args as { agentAddress: string; milestoneAmounts: string[] });
          
          case "generate_release_tx":
            return await this.generateReleaseTx(args as { projectId: string });
          
          case "generate_cancel_tx":
            return await this.generateCancelTx(args as { projectId: string });
  ...
  private async estimateCreateProject(args: { agentAddress: string; milestoneAmounts: string[] }) {
  ...
  private async generateReleaseTx(args: { projectId: string }) {
  ...
  private async generateCancelTx(args: { projectId: string }) {
